...
public interface IPolicyService : IService
{
    ...
    Task<GetPoliciesResponse> GetPoliciesByProperty(GetPoliciesByPropertyDto query, CancellationToken cancellationToken = default);

    Task<GetPolicyResponse> GetPolicyById(GetPolicyDto query, CancellationToken cancellationToken = default);

    Task<GetPolicyResponse> GetPolicyByProperty(GetPolicyByPropertyDto query, CancellationToken cancellationToken = default);
