...
public interface IEmailTemplateService : IService
{
    ...
    public Task<EmailTemplateDto> GetPasswordResetSuccesfulEmail(string name, string loginUrl, DateTime resetTime, CancellationToken cancellationToken = default);
