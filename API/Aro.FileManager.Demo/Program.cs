...
try
{
    ...
    Console.WriteLine("╚════════════════════════════════════════════╝");
    Console.WriteLine();
    Console.WriteLine("This application demonstrates the usage of file management components:");
    ...
    Console.WriteLine("  4. FileResourceService  - Coordinated storage + DB operations");
    Console.WriteLine();
    ...
    await FileResourceServiceDemo.Run();
